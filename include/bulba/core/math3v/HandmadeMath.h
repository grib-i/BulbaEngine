...
static inline HMM_Mat4 HMM_InvGeneralM4(HMM_Mat4 Matrix) {
  ...
  HMM_Mat4 Result;
  Result.Columns[0] =
      HMM_V4V(HMM_AddV3(HMM_Cross(Matrix.Columns[1].xyz, B32), HMM_MulV3F(C23, Matrix.Columns[1].w)), -HMM_DotV3(Matrix.Columns[1].xyz, C23));
  Result.Columns[1] =
      HMM_V4V(HMM_SubV3(HMM_Cross(B32, Matrix.Columns[0].xyz), HMM_MulV3F(C23, Matrix.Columns[0].w)), +HMM_DotV3(Matrix.Columns[0].xyz, C23));
  Result.Columns[2] =
      HMM_V4V(HMM_AddV3(HMM_Cross(Matrix.Columns[3].xyz, B10), HMM_MulV3F(C01, Matrix.Columns[3].w)), -HMM_DotV3(Matrix.Columns[3].xyz, C01));
  Result.Columns[3] =
      HMM_V4V(HMM_SubV3(HMM_Cross(B10, Matrix.Columns[2].xyz), HMM_MulV3F(C01, Matrix.Columns[2].w)), +HMM_DotV3(Matrix.Columns[2].xyz, C01));
...
static inline HMM_Quat HMM_M4ToQ_RH(HMM_Mat4 M) {
  ...
  if (M.Elements[2][2] < 0.0f) {
    if (M.Elements[0][0] > M.Elements[1][1]) {
      ...
      Q = HMM_Q(T, M.Elements[0][1] + M.Elements[1][0], M.Elements[2][0] + M.Elements[0][2], M.Elements[1][2] - M.Elements[2][1]);
    } else {
      ASSERT_COVERED(HMM_M4ToQ_RH);

      T = 1 - M.Elements[0][0] + M.Elements[1][1] - M.Elements[2][2];
      Q = HMM_Q(M.Elements[0][1] + M.Elements[1][0], T, M.Elements[1][2] + M.Elements[2][1], M.Elements[2][0] - M.Elements[0][2]);
    }
  } else {
    if (M.Elements[0][0] < -M.Elements[1][1]) {
      ASSERT_COVERED(HMM_M4ToQ_RH);
      ...
      T = 1 - M.Elements[0][0] - M.Elements[1][1] + M.Elements[2][2];
      Q = HMM_Q(M.Elements[2][0] + M.Elements[0][2], M.Elements[1][2] + M.Elements[2][1], T, M.Elements[0][1] - M.Elements[1][0]);
    } else {
      ASSERT_COVERED(HMM_M4ToQ_RH);

      T = 1 + M.Elements[0][0] + M.Elements[1][1] + M.Elements[2][2];
      Q = HMM_Q(M.Elements[1][2] - M.Elements[2][1], M.Elements[2][0] - M.Elements[0][2], M.Elements[0][1] - M.Elements[1][0], T);
    }
  }
...
static inline HMM_Quat HMM_M4ToQ_LH(HMM_Mat4 M) {
  ...
  if (M.Elements[2][2] < 0.0f) {
    if (M.Elements[0][0] > M.Elements[1][1]) {
      ...
      T = 1 + M.Elements[0][0] - M.Elements[1][1] - M.Elements[2][2];
      Q = HMM_Q(T, M.Elements[0][1] + M.Elements[1][0], M.Elements[2][0] + M.Elements[0][2], M.Elements[2][1] - M.Elements[1][2]);
    } else {
      ASSERT_COVERED(HMM_M4ToQ_LH);

      T = 1 - M.Elements[0][0] + M.Elements[1][1] - M.Elements[2][2];
      Q = HMM_Q(M.Elements[0][1] + M.Elements[1][0], T, M.Elements[1][2] + M.Elements[2][1], M.Elements[0][2] - M.Elements[2][0]);
    }
  } else {
    if (M.Elements[0][0] < -M.Elements[1][1]) {
      ASSERT_COVERED(HMM_M4ToQ_LH);
      ...
      T = 1 - M.Elements[0][0] - M.Elements[1][1] + M.Elements[2][2];
      Q = HMM_Q(M.Elements[2][0] + M.Elements[0][2], M.Elements[1][2] + M.Elements[2][1], T, M.Elements[1][0] - M.Elements[0][1]);
    } else {
      ASSERT_COVERED(HMM_M4ToQ_LH);

      T = 1 + M.Elements[0][0] + M.Elements[1][1] + M.Elements[2][2];
      Q = HMM_Q(M.Elements[2][1] - M.Elements[1][2], M.Elements[0][2] - M.Elements[2][0], M.Elements[1][0] - M.Elements[0][2], T);
    }
  }
...
#define HMM_Mul(A, B)                                                                                                                                \
  _Generic((B),                                                                                                                                      \
      ...
      HMM_Vec2: _Generic((A), HMM_Vec2: HMM_MulV2, HMM_Mat2: HMM_MulM2V2, default: __hmm_invalid_generic),                                           \
      HMM_Vec3: _Generic((A), HMM_Vec3: HMM_MulV3, HMM_Mat3: HMM_MulM3V3, default: __hmm_invalid_generic),                                           \
      HMM_Vec4: _Generic((A), HMM_Vec4: HMM_MulV4, HMM_Mat4: HMM_MulM4V4, default: __hmm_invalid_generic),                                           \
      HMM_Mat2: HMM_MulM2,                                                                                                                           \
      HMM_Mat3: HMM_MulM3,                                                                                                                           \
      HMM_Mat4: HMM_MulM4,                                                                                                                           \
...
#define HMM_LenSqr(A) _Generic((A), HMM_Vec2: HMM_LenSqrV2, HMM_Vec3: HMM_LenSqrV3, HMM_Vec4: HMM_LenSqrV4)(A)

#define HMM_Norm(A) _Generic((A), HMM_Vec2: HMM_NormV2, HMM_Vec3: HMM_NormV3, HMM_Vec4: HMM_NormV4, HMM_Quat: HMM_NormQ)(A)

#define HMM_Dot(A, B) _Generic((A), HMM_Vec2: HMM_DotV2, HMM_Vec3: HMM_DotV3, HMM_Vec4: HMM_DotV4, HMM_Quat: HMM_DotQ)(A, B)

#define HMM_Lerp(A, T, B) _Generic((A), float: HMM_Lerp, HMM_Vec2: HMM_LerpV2, HMM_Vec3: HMM_LerpV3, HMM_Vec4: HMM_LerpV4)(A, T, B)

#define HMM_Eq(A, B) _Generic((A), HMM_Vec2: HMM_EqV2, HMM_Vec3: HMM_EqV3, HMM_Vec4: HMM_EqV4)(A, B)

#define HMM_Transpose(M) _Generic((M), HMM_Mat2: HMM_TransposeM2, HMM_Mat3: HMM_TransposeM3, HMM_Mat4: HMM_TransposeM4)(M)

#define HMM_Determinant(M) _Generic((M), HMM_Mat2: HMM_DeterminantM2, HMM_Mat3: HMM_DeterminantM3, HMM_Mat4: HMM_DeterminantM4)(M)

#define HMM_InvGeneral(M) _Generic((M), HMM_Mat2: HMM_InvGeneralM2, HMM_Mat3: HMM_InvGeneralM3, HMM_Mat4: HMM_InvGeneralM4)(M)
